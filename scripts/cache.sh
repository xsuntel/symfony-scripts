...
setPhp() {
  ...
  # >>>> PHP - Symfony Framework - Back-End - Database    - Not required


  # >>>> PHP - Symfony Framework - Back-End - Cron jobs   - Not required


  # >>>> PHP - Symfony Framework - Back-End - Messenger   - Not required
