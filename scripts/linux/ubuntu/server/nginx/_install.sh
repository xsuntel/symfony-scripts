...
if [ "${PLATFORM_TYPE}" == "Linux" ]; then
  ...
  if [ "${ENVIRONMENT_NAME}" == "dev" ]; then
    ...
    sudo cp -fv ${PROJECT_PATH}/scripts/linux/ubuntu/server/nginx/conf.d/www_${ENVIRONMENT_NAME}.conf /etc/nginx/conf.d/${PROJECT_NAME}.conf
  else
