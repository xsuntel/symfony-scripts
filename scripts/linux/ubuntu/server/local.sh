...
setPlatform() {
  ...
  if [ "${PLATFORM_TYPE}" == "Linux" ]; then
    ...
    sudo ufw allow from any to any port 80 proto tcp  comment 'Nginx - HTTP'
    sudo ufw allow from any to any port 443 proto tcp comment 'Nginx - HTTPS'
    ...
    #sudo ufw allow from 192.168.0.0/24 to 192.168.0.0/24 port 3389 proto tcp comment 'RDP'
