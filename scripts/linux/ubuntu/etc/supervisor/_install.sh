...
if [ "${PLATFORM_TYPE}" == "Linux" ]; then
  ...
  sudo cp -fv ${PROJECT_PATH}/scripts/linux/ubuntu/etc/supervisor/conf.d/messenger-worker_${ENVIRONMENT_NAME}.conf /etc/supervisor/conf.d/messenger-worker.conf
  echo
