...
if [ "${PLATFORM_TYPE}" == "Darwin" ]; then
  ...
  # --------------------------------------------------------------------------------------------------------------------
  if [ -f ${PROJECT_PATH}/scripts/deploy/macos/device/etc/php/${PHP_VERSION}/php.ini ]; then
    echo ">>>> PHP - Configuration"
    cp -fv ${PROJECT_PATH}/scripts/deploy/macos/device/etc/php/${PHP_VERSION}/php.ini /opt/homebrew/etc/php/${PHP_VERSION}/
    echo
  fi
