...
setCDN() {
  ...
  #if [ -f ${PROJECT_PATH}/scripts/deploy/prod/aws/elasticbeanstalk/_s3.sh ]; then
  #  source ${PROJECT_PATH}/scripts/deploy/prod/aws/elasticbeanstalk/_s3.sh
  #else
  #  echo "Please check a file : ${PROJECT_PATH}/scripts/deploy/prod/aws/elasticbeanstalk/_s3.sh" && exit
  #fi
  #echo
}
