...
setPlatform() {
  ...
  # >>>> Linux - Server
  if [ -f "${PROJECT_PATH}/scripts/common/server/supervisor/_install.sh" ]; then
    source "${PROJECT_PATH}/scripts/common/server/supervisor/_install.sh"
  else
    echo "Please check a file : ./scripts/common/server/supervisor/_install.sh" && exit
  fi
  echo
}
...
setRedis() {
  ...
  # >>>> Redis
  if [ -f "${PROJECT_PATH}"/scripts/common/cache/redis/_install.sh ]; then
    source "${PROJECT_PATH}"/scripts/common/cache/redis/_install.sh
  else
    echo "Please check a file : ./scripts/common/cache/redis/_install.sh" && exit
  fi
  echo
}
...
setRabbitMQ() {
  ...
  # >>>> RabbitMQ
  if [ -f "${PROJECT_PATH}"/scripts/common/message/rabbitmq/_install.sh ]; then
    source "${PROJECT_PATH}"/scripts/common/message/rabbitmq/_install.sh
  else
    echo "Please check a file : ./scripts/common/message/rabbitmq/_install.sh" && exit
  fi
  echo
}
...
setNginx() {
  ...
  # >>>> Nginx
  if [ -f "${PROJECT_PATH}"/scripts/common/server/nginx/_install.sh ]; then
    source "${PROJECT_PATH}"/scripts/common/server/nginx/_install.sh
  else
    echo "Please check a file : ./scripts/common/server/nginx/_install.sh" && exit
  fi
  echo
}
...
setBuild() {
  ...
  if [ -f "${PROJECT_PATH}"/scripts/common/app/symfony/common/_permissions.sh ]; then
    source "${PROJECT_PATH}"/scripts/common/app/symfony/common/_permissions.sh
  else
    echo "Please check a file : ./scripts/common/app/symfony/common/_permissions.sh" && exit
  fi
  echo

  # >>>> PHP - Symfony Framework - Deployment - Back-End  - Database    - (Optional)
  #if [ -f "${PROJECT_PATH}"/scripts/common/app/symfony/common/_database.sh ]; then
  #  source "${PROJECT_PATH}"/scripts/common/app/symfony/common/_database.sh
  #else
  #  echo "Please check a file : ./scripts/common/app/symfony/common/_database.sh" && exit
  #fi
  #echo

  # >>>> PHP - Symfony Framework - Deployment - Back-End  - Cron jobs   - (Optional)
  #if [ -f "${PROJECT_PATH}"/scripts/common/app/symfony/common/_cron.sh ]; then
  #  source "${PROJECT_PATH}"/scripts/common/app/symfony/common/_cron.sh
  #else
  #  echo "Please check a file : ./scripts/common/app/symfony/common/_cron.sh" && exit
  #fi
  #echo

  # >>>> PHP - Symfony Framework - Deployment - Back-End  - Messenger   - (Optional)
  if [ -f "${PROJECT_PATH}"/scripts/common/app/symfony/common/_messenger.sh ]; then
    source "${PROJECT_PATH}"/scripts/common/app/symfony/common/_messenger.sh
  else
    echo "Please check a file : ./scripts/common/app/symfony/common/_messenger.sh" && exit
  fi
  echo
...
setProvider() {
  ...
  #if [ -f "${PROJECT_PATH}"/scripts/deploy/prod/aws/_cli.sh ]; then
  #  source "${PROJECT_PATH}"/scripts/deploy/prod/aws/_cli.sh
  #else
  #  echo "Please check a file : ./scripts/deploy/prod/aws/_cli.sh" && exit
  #fi
  #echo

  # >>>> AWS - Base - Import a CDN file
  #if [ -f "${PROJECT_PATH}"/scripts/deploy/prod/aws/_s3.sh ]; then
  #  source "${PROJECT_PATH}"/scripts/deploy/prod/aws/_s3.sh
  #else
  #  echo "Please check a file : ./scripts/deploy/prod/aws/_s3.sh" && exit
  #fi
  #echo
}
