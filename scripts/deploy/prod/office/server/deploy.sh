...
setPostgreSQL() {
  ...
  # >>>> PostgreSQL
  if [ -f "${PROJECT_PATH}"/scripts/base/database/postgresql/_install.sh ]; then
    source "${PROJECT_PATH}"/scripts/base/database/postgresql/_install.sh
  else
    echo "Please check a file : ./scripts/base/database/postgresql/_install.sh" && exit
  fi
  echo
}
...
setBuild() {
  ...
  if [ -f "${PROJECT_PATH}"/scripts/base/app/symfony/config/_permissions.sh ]; then
    source "${PROJECT_PATH}"/scripts/base/app/symfony/config/_permissions.sh
  else
    echo "Please check a file : ./scripts/base/app/symfony/config/_permissions.sh" && exit
  fi
  echo

  # >>>> PHP - Symfony Framework - Deployment - Back-End  - Database    - (Optional)
  #if [ -f "${PROJECT_PATH}"/scripts/base/app/symfony/config/_database.sh ]; then
  #  source "${PROJECT_PATH}"/scripts/base/app/symfony/config/_database.sh
  #else
  #  echo "Please check a file : ./scripts/base/app/symfony/config/_database.sh" && exit
  #fi
  #echo

  # >>>> PHP - Symfony Framework - Deployment - Back-End  - Cron jobs   - (Optional)
  #if [ -f "${PROJECT_PATH}"/scripts/base/app/symfony/config/_cron.sh ]; then
  #  source "${PROJECT_PATH}"/scripts/base/app/symfony/config/_cron.sh
  #else
  #  echo "Please check a file : ./scripts/base/app/symfony/config/_cron.sh" && exit
  #fi
  #echo

  # >>>> PHP - Symfony Framework - Deployment - Back-End  - Messenger   - (Optional)
  if [ -f "${PROJECT_PATH}"/scripts/base/app/symfony/config/_messenger.sh ]; then
    source "${PROJECT_PATH}"/scripts/base/app/symfony/config/_messenger.sh
  else
    echo "Please check a file : ./scripts/base/app/symfony/config/_messenger.sh" && exit
  fi
  echo
  ...
  #if [ -f "${PROJECT_PATH}"/scripts/base/app/symfony/config/assets/_webpack.sh ]; then
  #  source "${PROJECT_PATH}"/scripts/base/app/symfony/config/assets/_webpack.sh
  #else
  #  echo "Please check a file : ./scripts/base/app/symfony/config/assets/_webpack.sh" && exit
  #fi
  #echo
}
