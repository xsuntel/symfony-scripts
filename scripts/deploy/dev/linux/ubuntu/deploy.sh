#!/bin/bash
# ======================================================================================================================
# Scripts - Deploy - Dev - Linux - Ubuntu
# ======================================================================================================================
...
setPlatform() {
  ...
  # >>>> Linux - Network
  if [ -f "${PROJECT_PATH}/scripts/deploy/dev/linux/ubuntu/utility/base/network/_base.sh" ]; then
    source "${PROJECT_PATH}/scripts/deploy/dev/linux/ubuntu/utility/base/network/_base.sh"
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/deploy/dev/linux/ubuntu/utility/base/network/_base.sh" && exit
  fi
  echo

  # >>>> Linux - Packages
  if [ -f "${PROJECT_PATH}/scripts/deploy/dev/linux/ubuntu/utility/base/packages/_base.sh" ]; then
    source "${PROJECT_PATH}/scripts/deploy/dev/linux/ubuntu/utility/base/packages/_base.sh"
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/deploy/dev/linux/ubuntu/utility/base/packages/_base.sh" && exit
  fi
  echo

  # >>>> Linux - Security
  if [ -f "${PROJECT_PATH}/scripts/deploy/dev/linux/ubuntu/utility/base/security/_base.sh" ]; then
    source "${PROJECT_PATH}/scripts/deploy/dev/linux/ubuntu/utility/base/security/_base.sh"
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/deploy/dev/linux/ubuntu/utility/base/security/_base.sh" && exit
  fi
  echo
}
