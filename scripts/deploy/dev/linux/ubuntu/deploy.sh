...
setPlatform() {
  ...
  # >>>> Linux - Network
  if [ -f "${PROJECT_PATH}"/scripts/deploy/dev/linux/ubuntu/utility/base/_network.sh ]; then
    source "${PROJECT_PATH}"/scripts/deploy/dev/linux/ubuntu/utility/base/_network.sh
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/deploy/dev/linux/ubuntu/utility/base/_network.sh" && exit
  fi
  echo

  # >>>> Linux - Packages
  if [ -f "${PROJECT_PATH}"/scripts/deploy/dev/linux/ubuntu/utility/base/_packages.sh ]; then
    source "${PROJECT_PATH}"/scripts/deploy/dev/linux/ubuntu/utility/base/_packages.sh
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/deploy/dev/linux/ubuntu/utility/base/_packages.sh" && exit
  fi
  echo

  # >>>> Linux - Security
  if [ -f "${PROJECT_PATH}"/scripts/deploy/dev/linux/ubuntu/utility/base/_security.sh ]; then
    source "${PROJECT_PATH}"/scripts/deploy/dev/linux/ubuntu/utility/base/_security.sh
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/deploy/dev/linux/ubuntu/utility/base/_security.sh" && exit
  fi
  echo
}
...
setPostgreSQL() {
  ...
  if [ -f "${PROJECT_PATH}"/scripts/base/database/postgresql/_install.sh ]; then
    ...
    echo "Please check a file : ${PROJECT_PATH}/scripts/base/database/postgresql/_install.sh" && exit
  fi
  echo
}
