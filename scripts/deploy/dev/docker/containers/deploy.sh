...
setRedis() {
  ...
  if [ "${PLATFORM_TYPE}" == "Linux" ]; then
    ...
    # ------------------------------------------------------------------------------------------------------------------
    # >>>> Import an install file
    if [ -f ${PROJECT_PATH}/scripts/deploy/dev/macos/ubuntu/cache/redis/_install.sh ]; then
      source ${PROJECT_PATH}/scripts/deploy/dev/macos/ubuntu/cache/redis/_install.sh
    else
      echo "Please check a file : ${PROJECT_PATH}/scripts/deploy/dev/macos/ubuntu/cache/redis/_install.sh" && exit
    fi
    ...
    # ------------------------------------------------------------------------------------------------------------------
    # >>>> Import an install file
    if [ -f ${PROJECT_PATH}/scripts/deploy/dev/windows/ubuntu/cache/redis/_install.sh ]; then
      source ${PROJECT_PATH}/scripts/deploy/dev/windows/ubuntu/cache/redis/_install.sh
    else
      echo "Please check a file : ${PROJECT_PATH}/scripts/deploy/dev/windows/ubuntu/cache/redis/_install.sh" && exit
    fi
...
setRabbitMQ() {
  ...
  if [ "${PLATFORM_TYPE}" == "Linux" ]; then
    ...
    # ------------------------------------------------------------------------------------------------------------------
    # >>>> Import an install file
    if [ -f ${PROJECT_PATH}/scripts/deploy/dev/macos/ubuntu/message/rabbitmq/_install.sh ]; then
      source ${PROJECT_PATH}/scripts/deploy/dev/macos/ubuntu/message/rabbitmq/_install.sh
    else
      echo "Please check a file : ${PROJECT_PATH}/scripts/deploy/dev/macos/ubuntu/message/rabbitmq/_install.sh" && exit
    fi
    ...
    # ------------------------------------------------------------------------------------------------------------------
    # >>>> Import an install file
    if [ -f ${PROJECT_PATH}/scripts/deploy/dev/windows/ubuntu/message/rabbitmq/_install.sh ]; then
      source ${PROJECT_PATH}/scripts/deploy/dev/windows/ubuntu/message/rabbitmq/_install.sh
    else
      echo "Please check a file : ${PROJECT_PATH}/scripts/deploy/dev/windows/ubuntu/message/rabbitmq/_install.sh" && exit
    fi
