...
setPlatform() {
  ...
  # >>>> OS - Network
  if [ -f "${PROJECT_PATH}"/scripts/deploy/dev/linux/windows/device/utility/base/_network.sh ]; then
    source "${PROJECT_PATH}"/scripts/deploy/dev/linux/windows/device/utility/base/_network.sh
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/deploy/dev/linux/windows/device/utility/base/_network.sh" && exit
  fi
  echo

  # >>>> OS - Packages
  if [ -f "${PROJECT_PATH}"/scripts/deploy/dev/linux/windows/device/utility/base/_packages.sh ]; then
    source "${PROJECT_PATH}"/scripts/deploy/dev/linux/windows/device/utility/base/_packages.sh
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/deploy/dev/linux/windows/device/utility/base/_packages.sh" && exit
  fi
  echo

  # >>>> OS - Security
  if [ -f "${PROJECT_PATH}"/scripts/deploy/dev/linux/windows/device/utility/base/_security.sh ]; then
    source "${PROJECT_PATH}"/scripts/deploy/dev/linux/windows/device/utility/base/_security.sh
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/deploy/dev/linux/windows/device/utility/base/_security.sh" && exit
  fi
  echo
}
...
setDocker() {
  ...
  if [ -f "${PROJECT_PATH}/scripts/deploy/${ENVIRONMENT_NAME}/windows/device/utility/docker/docker-compose.env" ]; then
    cp -fv "${PROJECT_PATH}/scripts/deploy/${ENVIRONMENT_NAME}/windows/device/utility/docker/docker-compose.env" "${PROJECT_PATH}"
    echo
  fi

  if [ -f "${PROJECT_PATH}/scripts/deploy/${ENVIRONMENT_NAME}/windows/device/utility/docker/docker-compose.yml" ]; then
    cp -fv "${PROJECT_PATH}/scripts/deploy/${ENVIRONMENT_NAME}/windows/device/utility/docker/docker-compose.yml" "${PROJECT_PATH}"
    echo
  fi
  echo
