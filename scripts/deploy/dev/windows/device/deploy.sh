...
setPlatform() {
  ...
  # >>>> OS - Network
  if [ -f ${PROJECT_PATH}/scripts/deploy/dev/linux/windows/device/tools/_network.sh ]; then
    source ${PROJECT_PATH}/scripts/deploy/dev/linux/windows/device/tools/_network.sh
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/deploy/dev/linux/windows/device/tools/_network.sh" && exit
  fi
  echo

  # >>>> OS - Packages
  if [ -f ${PROJECT_PATH}/scripts/deploy/dev/linux/windows/device/tools/_packages.sh ]; then
    source ${PROJECT_PATH}/scripts/deploy/dev/linux/windows/device/tools/_packages.sh
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/deploy/dev/linux/windows/device/tools/_packages.sh" && exit
  fi
  echo

  # >>>> OS - Security
  if [ -f ${PROJECT_PATH}/scripts/deploy/dev/linux/windows/device/tools/_security.sh ]; then
    source ${PROJECT_PATH}/scripts/deploy/dev/linux/windows/device/tools/_security.sh
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/deploy/dev/linux/windows/device/tools/_security.sh" && exit
  fi
  echo
}
...
setDocker() {
  ...
  if [ -f ${PROJECT_PATH}/scripts/deploy/dev/windows/device/tools/docker/docker-compose.yml ]; then
    cp -fv ${PROJECT_PATH}/scripts/deploy/dev/windows/device/tools/docker/docker-compose.yml ${PROJECT_PATH}
    echo
  fi

  if [ -f ${PROJECT_PATH}/scripts/deploy/dev/windows/device/tools/docker/docker-compose.${ENVIRONMENT_NAME}.env ] && [ -f ${PROJECT_PATH}/scripts/deploy/dev/windows/device/tools/docker/docker-compose.${ENVIRONMENT_NAME}.yml ]; then
    cp -fv ${PROJECT_PATH}/scripts/deploy/dev/windows/device/tools/docker/docker-compose.${ENVIRONMENT_NAME}.* ${PROJECT_PATH}
    echo
  fi
