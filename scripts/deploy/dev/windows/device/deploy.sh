...
setVM() {
  ...
  if [ -f ${PROJECT_PATH}/scripts/base/app/symfony/_supervisor.sh ]; then
    source ${PROJECT_PATH}/scripts/base/app/symfony/_supervisor.sh
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/base/app/symfony/_supervisor.sh" && exit
  fi
  echo
