...
setPlatform() {
  ...
  # >>>> OS - Network
  if [ -f ${PROJECT_PATH}/scripts/deploy/dev/linux/windows/device/_network.sh ]; then
    source ${PROJECT_PATH}/scripts/deploy/dev/linux/windows/device/_network.sh
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/deploy/dev/linux/windows/device/_network.sh" && exit
  fi
  echo

  # >>>> OS - Packages
  if [ -f ${PROJECT_PATH}/scripts/deploy/dev/linux/windows/device/_packages.sh ]; then
    source ${PROJECT_PATH}/scripts/deploy/dev/linux/windows/device/_packages.sh
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/deploy/dev/linux/windows/device/_packages.sh" && exit
  fi
  echo

  # >>>> OS - Security
  if [ -f ${PROJECT_PATH}/scripts/deploy/dev/linux/windows/device/_security.sh ]; then
    source ${PROJECT_PATH}/scripts/deploy/dev/linux/windows/device/_security.sh
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/deploy/dev/linux/windows/device/_security.sh" && exit
  fi
  echo
}
