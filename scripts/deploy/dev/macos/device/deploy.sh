...
setPlatform() {
  ...
  # >>>> OS - Network
  if [ -f "${PROJECT_PATH}"/scripts/deploy/dev/linux/macos/device/utility/base/network/_base.sh ]; then
    source "${PROJECT_PATH}"/scripts/deploy/dev/linux/macos/device/utility/base/network/_base.sh
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/deploy/dev/linux/macos/device/utility/base/network/_base.sh" && exit
  fi
  echo

  # >>>> OS - Packages
  if [ -f "${PROJECT_PATH}"/scripts/deploy/dev/linux/macos/device/utility/base/packages/_base.sh ]; then
    source "${PROJECT_PATH}"/scripts/deploy/dev/linux/macos/device/utility/base/packages/_base.sh
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/deploy/dev/linux/macos/device/utility/base/packages/_base.sh" && exit
  fi
  echo

  # >>>> OS - Security
  if [ -f "${PROJECT_PATH}"/scripts/deploy/dev/linux/macos/device/utility/base/security/_base.sh ]; then
    source "${PROJECT_PATH}"/scripts/deploy/dev/linux/macos/device/utility/base/security/_base.sh
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/deploy/dev/linux/macos/device/utility/base/security/_base.sh" && exit
  fi
  echo
}
