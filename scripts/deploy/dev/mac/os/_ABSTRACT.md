...
```bash
./scripts/deploy/dev/mac/os/deploy.sh
```

* Check status

```bash
./scripts/deploy/dev/mac/os/status.sh
```
...
```bash
./scripts/base/app/symfony/console/assets.sh
```

* Cache

```bash
./scripts/base/app/symfony/console/cache.sh
```

* Migrations

```bash
./scripts/base/app/symfony/console/database.sh
```

* Messenger

```bash
./scripts/base/app/symfony/console/message.sh
```
