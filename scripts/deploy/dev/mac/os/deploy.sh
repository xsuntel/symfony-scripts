...
setUtility() {
  ...
  if [ -f "${PROJECT_PATH}"/scripts/base/app/symfony/base/_server.sh ]; then
    source "${PROJECT_PATH}"/scripts/base/app/symfony/base/_server.sh
  else
    echo "Please check a file : ./scripts/base/app/symfony/base/_server.sh" && exit
  fi
  echo
}
