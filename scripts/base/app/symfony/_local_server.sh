#!/bin/bash
# ======================================================================================================================
# Scripts - Base - App - Symfony - Local Web Server            https://symfony.com/doc/current/setup/symfony_server.html
# ======================================================================================================================
    ...
    if [ -f bin/console ]; then
      ...
      if [ "${ENVIRONMENT_NAME}" == "dev" ]; then
        ...
        if [ "${PLATFORM_TYPE}" == "Linux" ]; then
          ...
          # >>>> App - Symfony - Local Web Server - Enabling TLS
