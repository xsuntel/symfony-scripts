#!/bin/bash
# ======================================================================================================================
# Scripts - Symfony - Front-End                                            https://symfony.com/doc/current/frontend.html
# ======================================================================================================================
...
if [ -d app ]; then
  (
    ...
    if [ -f bin/console ]; then
      ...
      if [ "${ENVIRONMENT_NAME}" == "dev" ]; then
        echo ">>>> PHP - Symfony - Bundles - TailwindBundle - StandAlone CLI"
        echo
        ...
        # >>>> NPM : Add TailWindCSS
        if [ ! -d ${PROJECT_PATH}/app/node_modules/tailwindcss ]; then
