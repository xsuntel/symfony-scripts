...
if [ "${PLATFORM_TYPE}" == "Linux" ]; then
  ...
  local addPackageList="curl git wget unzip net-tools supervisor"
  ...
  local delPackageList="cups cups-browsed whoopsie kerneloops apport openssh-server putty putty-tools nmap"
