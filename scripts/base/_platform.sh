...
if [ "${PLATFORM_TYPE}" == "Linux" ]; then
  ...
  #if [ -f ${PROJECT_PATH}/scripts/linux/ubuntu/etc/supervisor/_install.sh ]; then
  #  source ${PROJECT_PATH}/scripts/linux/ubuntu/etc/supervisor/_install.sh
  #else
  #  echo "Please check a file : ${PROJECT_PATH}/scripts/linux/ubuntu/etc/supervisor/_install.sh" && exit
  #fi
  #echo
