...
setPhp() {
  ...
  if [ "${PLATFORM_TYPE}" == "Linux" ]; then
    ...
    # ------------------------------------------------------------------------------------------------------------------
    # >>>> Import an install file
    if [ -f ${PROJECT_PATH}/scripts/develop/macos/device/etc/php/_install.sh ]; then
      source ${PROJECT_PATH}/scripts/develop/macos/device/etc/php/_install.sh
    else
      echo "Please check a file : ${PROJECT_PATH}/scripts/develop/macos/device/etc/php/_install.sh" && exit
    fi
    ...
    # ------------------------------------------------------------------------------------------------------------------
    # >>>> Import an install file
    if [ -f ${PROJECT_PATH}/scripts/develop/windows/device/app/php/_install.sh ]; then
      source ${PROJECT_PATH}/scripts/develop/windows/device/app/php/_install.sh
    else
      echo "Please check a file : ${PROJECT_PATH}/scripts/develop/windows/device/app/php/_install.sh" && exit
    fi
...
setRedis() {
  ...
  if [ "${PLATFORM_TYPE}" == "Linux" ]; then
    ...
    # ------------------------------------------------------------------------------------------------------------------
    # >>>> Import an install file
    if [ -f ${PROJECT_PATH}/scripts/develop/macos/ubuntu/cache/redis/_install.sh ]; then
      source ${PROJECT_PATH}/scripts/develop/macos/ubuntu/cache/redis/_install.sh
    else
      echo "Please check a file : ${PROJECT_PATH}/scripts/develop/macos/ubuntu/cache/redis/_install.sh" && exit
    fi
    ...
    # ------------------------------------------------------------------------------------------------------------------
    # >>>> Import an install file
    if [ -f ${PROJECT_PATH}/scripts/develop/windows/ubuntu/cache/redis/_install.sh ]; then
      source ${PROJECT_PATH}/scripts/develop/windows/ubuntu/cache/redis/_install.sh
    else
      echo "Please check a file : ${PROJECT_PATH}/scripts/develop/windows/ubuntu/cache/redis/_install.sh" && exit
    fi
...
setRabbitMQ() {
  ...
  if [ "${PLATFORM_TYPE}" == "Linux" ]; then
    ...
    # ------------------------------------------------------------------------------------------------------------------
    # >>>> Import an install file
    if [ -f ${PROJECT_PATH}/scripts/develop/macos/ubuntu/message/rabbitmq/_install.sh ]; then
      source ${PROJECT_PATH}/scripts/develop/macos/ubuntu/message/rabbitmq/_install.sh
    else
      echo "Please check a file : ${PROJECT_PATH}/scripts/develop/macos/ubuntu/message/rabbitmq/_install.sh" && exit
    fi
    ...
    # ------------------------------------------------------------------------------------------------------------------
    # >>>> Import an install file
    if [ -f ${PROJECT_PATH}/scripts/develop/windows/ubuntu/message/rabbitmq/_install.sh ]; then
      source ${PROJECT_PATH}/scripts/develop/windows/ubuntu/message/rabbitmq/_install.sh
    else
      echo "Please check a file : ${PROJECT_PATH}/scripts/develop/windows/ubuntu/message/rabbitmq/_install.sh" && exit
    fi
