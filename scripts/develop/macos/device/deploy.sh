...
setPlatform() {
  ...
  if [ -f ${PROJECT_PATH}/scripts/develop/linux/macos/device/_network.sh ]; then
    source ${PROJECT_PATH}/scripts/develop/linux/macos/device/_network.sh
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/develop/linux/macos/device/_network.sh" && exit
  fi
  echo

  # >>>> Server - Packages - Import an install file
  if [ -f ${PROJECT_PATH}/scripts/develop/linux/macos/device/_packages.sh ]; then
    source ${PROJECT_PATH}/scripts/develop/linux/macos/device/_packages.sh
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/develop/linux/macos/device/_packages.sh" && exit
  fi
  echo

  # >>>> Server - Security - Import an install file
  if [ -f ${PROJECT_PATH}/scripts/develop/linux/macos/device/_security.sh ]; then
    source ${PROJECT_PATH}/scripts/develop/linux/macos/device/_security.sh
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/develop/linux/macos/device/_security.sh" && exit
  fi
  echo
}
...
setPhp() {
  ...
  if [ -f ${PROJECT_PATH}/scripts/develop/macos/device/app/php/_install.sh ]; then
    source ${PROJECT_PATH}/scripts/develop/macos/device/app/php/_install.sh
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/develop/macos/device/app/php/_install.sh" && exit
  fi
...
setRedis() {
  ...
  if [ -f ${PROJECT_PATH}/scripts/develop/macos/device/cache/redis/_install.sh ]; then
    source ${PROJECT_PATH}/scripts/develop/macos/device/cache/redis/_install.sh
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/develop/macos/device/cache/redis/_install.sh" && exit
  fi
  echo
}
...
setRabbitMQ() {
  ...
  if [ -f ${PROJECT_PATH}/scripts/develop/macos/device/message/rabbitmq/_install.sh ]; then
    source ${PROJECT_PATH}/scripts/develop/macos/device/message/rabbitmq/_install.sh
  else
    echo "Please check a file : ${PROJECT_PATH}/scripts/develop/macos/device/message/rabbitmq/_install.sh" && exit
  fi
  echo
}
