...
setPlatform() {
  ...
  if [ "${PLATFORM_TYPE}" == "Darwin" ]; then
    ...
    if [ "${ENVIRONMENT_NAME}" == "dev" ]; then
      ...
      # ----------------------------------------------------------------------------------------------------------------
      # >>>> Import a host file
      if [ -f ${PROJECT_PATH}/scripts/macos/device/tools/settings/_hosts.sh ]; then
        source ${PROJECT_PATH}/scripts/macos/device/tools/settings/_hosts.sh
      else
        echo "Please check a file : ${PROJECT_PATH}/scripts/macos/device/tools/settings/_hosts.sh" && exit
      fi
      echo
