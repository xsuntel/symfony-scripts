...
if [ "${PLATFORM_TYPE}" == "Darwin" ]; then
  ...
  # >>>> PHP - Configurations
  if [ -f ${PROJECT_PATH}/scripts/macos/desktop/etc/php/${PHP_VERSION}/php.ini ]; then
    echo ">>>> PHP - php.ini"
    cp -fv ${PROJECT_PATH}/scripts/macos/desktop/etc/php/${PHP_VERSION}/php.ini /opt/homebrew/etc/php/${PHP_VERSION}/
    echo
  fi
