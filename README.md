...
* Download the application
  ...
  ```bash
  git clone https://github.com/xsuntel/symfony-scripts.git Scripts

  cd Scripts && find ./scripts/ -type f -name "*.sh" -exec chmod 775 {} \;
  ```
...
* AI
  * Antigravity - [Document](https://github.com/xsuntel/symfony-scripts/blob/main/tools/ai/antigravity/_ABSTRACT.md)
  * Claude
  * Cursor
* IDE
  * PhpStorm    - [Document](https://github.com/xsuntel/symfony-scripts/blob/main/tools/ide/phpstorm/_ABSTRACT.md)
  * VSCode      - [Document](https://github.com/xsuntel/symfony-scripts/blob/main/tools/ide/vscode/_ABSTRACT.md)
