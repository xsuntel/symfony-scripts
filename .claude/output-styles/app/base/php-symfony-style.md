...
@see .claude/rules/app/base/php-symfony/00-overview-rule.md ~ 11-performance-rule.md — 코딩 표준(SoT)
@see .claude/docs/app/base/php-symfony-docs.md — 레이어별 코드 템플릿
...
- 레이어 경계·모킹 정책 등 테스트 표준은 `.claude/rules/app/base/php-symfony/09-testing-rule.md` 참조.
