...
@see .claude/rules/app/base/javascript-stimulus/00-overview-rule.md ~ 02-quality-rule.md — 코딩 표준(SoT)
@see .claude/rules/app/base/php-symfony/10-frontend-rule.md — AssetMapper·importmap·부트스트랩
@see .claude/docs/app/base/javascript-stimulus-docs.md — StimulusBundle 통합·컴포넌트 예제
