...
- .claude/rules/app/base/php-symfony/01-architecture-rule.md, 04-service-rule.md, 05-doctrine-rule.md
- .claude/rules/cache/base/redis-config-rule.md (cache invalidation & locks)
