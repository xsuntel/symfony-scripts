...
- .claude/rules/app/base/php-symfony/09-testing-rule.md (test layers & mocking)
- .claude/rules/app/base/php-symfony/05-doctrine-rule.md (Repository & mapping)
