...
```bash
echo '{"tool_input":{"file_path":"app/src/{path}/{file}.php"}}' | .claude/hooks/post-tool-use/app-php-lint.sh
echo '{"tool_input":{"file_path":"app/src/{path}/{file}.php"}}' | .claude/hooks/post-tool-use/app-php-cs-fixer.sh
