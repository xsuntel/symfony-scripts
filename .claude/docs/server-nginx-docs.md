...
| ------ | ------------- | ------ |
| `scripts/common/server/nginx/nginx.conf` | Base / Ubuntu dev | Main http context (Ubuntu package paths) |
| `scripts/common/server/nginx/conf.d/symfony.conf` | Base / Ubuntu dev | Virtual host, port 80, Unix socket |
...
Annotated revision of `scripts/common/server/nginx/nginx.conf`:
...
Annotated revision of `scripts/common/server/nginx/conf.d/symfony.conf`:
