...
@see .claude/rules/server/cloud/aws/ecs-config-rule.md — ECS judgment criteria (SoT)
@see .claude/rules/server/cloud/gcp/cloudrun-config-rule.md — the project-default target
