...
| **Build** (generate-verify) | `app-php-symfony-author` | `app-javascript-stimulus-author` · `app-twig-symfony-author` | — | `api-platform-author` (+ providers self-verify against the `*-build` commands) | — (Shell Script self-verifies against the `/utility-shell-script-skill` skill) |
...
> and reviewer agents were merged into the slash command `/utility-claude-code-skill`, and the
> `utility-claude-code-skill` skill self-verifies against it (section 3.5).
>
> **Providers likewise stopped being Build team members on 2026-08-15** — the
...
- **Exception ① (agentless variant — meta and configuration):** since 2026-08-08, Claude Code
  configuration artifacts have **the slash command `/utility-claude-code-skill` hold the criteria**
  ...
  [Read: .claude/skills/utility-claude-code-skill/references/artifact-spec-guide.md]
...
- **Exception ③ (agentless variant — shell scripts):** `scripts/**` Bash scripts have worked the same
  way since 2026-08-16 — **the slash command `/utility-shell-script-skill` holds both the authoring
  ...
  [Read: .claude/skills/utility-shell-script-skill/references/review-guide.md]
