...
@see .claude/rules/message/base/rabbitmq-config-rule.md — RabbitMQ/Messenger judgment criteria (SoT)
@see .claude/docs/cache/base/redis-config-docs.md — the paired transport reference (Redis = sync only)
