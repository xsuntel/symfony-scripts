...
@see .claude/rules/app/base/twig-symfony/00-overview-rule.md — Twig standards & judgment criteria (SoT)
@see .claude/rules/app/base/php-symfony/07-template-rule.md — Twig naming, inheritance, components (SoT)
@see .claude/rules/app/base/php-symfony/10-frontend-rule.md — AssetMapper, Stimulus, UX
@see .claude/docs/app/base/twig-symfony-docs.md — syntax, filters, functions, detailed examples
