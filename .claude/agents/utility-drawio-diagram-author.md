...
memory: project
maxTurns: 30
tools: Bash, Read, Write, Glob, Grep, mcp__drawio-tool__list_pages, mcp__drawio-tool__get_page, mcp__drawio-tool__search_shapes
---
...
- Page names describe their content — never leave a default name such as `페이지-1`.
