...
# The Hangul alternative is data, not prose: draw.io names a new page "페이지-1" under a Korean locale and
# "Page-1" otherwise, so both spellings must be matched to detect an unrenamed default page.
