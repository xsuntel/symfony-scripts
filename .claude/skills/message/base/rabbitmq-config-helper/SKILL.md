...
@see .claude/rules/message/base/rabbitmq-config-rule.md — full transport/routing/retry/idempotency/worker standards (SoT)
@see .claude/rules/cache/base/redis-config-rule.md — paired transport rule (Redis = sync only) & lock stores
