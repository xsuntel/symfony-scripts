...
@see .claude/rules/server/base/nginx-config-rule.md — container nginx, port 8080 exposure, TLS termination, deployment checklist
@see .claude/rules/server/cloud/gcp/cloudrun-config-rule.md — full Cloud Run deployment/secrets/IAM/cost/IaC standards (SoT)
