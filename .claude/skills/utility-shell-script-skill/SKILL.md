...
Declared in `scripts/common/_abstract.sh` and available to every script sourced after it. Never
...
| ----------------- | -------------------------- | ------------------------------------------------------------------------------------------------ |
| Base              | `scripts/common/`          | Environment-independent install and configuration; sourced by both containers and deploy scripts |
...
**Common base:** `scripts/common/_abstract.sh` → `_environment.sh` → `_platform.sh` → `_project.sh`.
