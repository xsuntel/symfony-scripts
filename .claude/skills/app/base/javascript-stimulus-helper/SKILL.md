---
name: javascript-stimulus-helper
...
@see .claude/rules/app/base/javascript-stimulus/00-overview-rule.md ~ 02-quality-rule.md — module/controller/quality criteria (SoT)
@see .claude/rules/app/base/php-symfony/10-frontend-rule.md — AssetMapper/UX bundles
...
2. **Controller topology** → root shared controllers (dropdown/modal/popover, etc.) + domain subdirectories (mirroring the `app/src/` domains). See `php-symfony-helper` for backend boundaries.
...
4. Rule conflict? → React/Vue/Angular prohibited (`CLAUDE.md`), bundlers (Webpack/Vite) prohibited, no `<script src>` (`rules/.../10-frontend-rule.md`, output-style).
...
|---|---|
| Modules/naming | `rules/app/base/javascript-stimulus/00-overview-rule.md` |
| Controllers (targets/values/outlets/lifecycle) | `01-controller-rule.md` |
| Security/performance/quality | `02-quality-rule.md` |
| Code style | `output-styles/app/base/javascript-stimulus-style.md` |
| Twig/frontend | `rules/app/base/php-symfony/07-template-rule.md`, `10-frontend-rule.md` |
