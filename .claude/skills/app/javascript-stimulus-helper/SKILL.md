...
@see .claude/rules/app/javascript-stimulus/00-overview-rule.md ~ 02-quality-rule.md — module/controller/quality criteria (SoT)
...
| Twig/frontend | `rules/app/php-symfony/07-template-rule.md`, `10-frontend-rule.md` |
