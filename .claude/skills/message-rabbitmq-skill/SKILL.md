...
| Request | Mode | Read |
| --- | --- | --- |
| Message/handler authoring, transport, routing, retry, worker operation | Guide | this file |
| "review `<path>`", quality check of an existing file | **Review** | [`references/review-guide.md`](references/review-guide.md) |

> The Review mode was the slash command `/message-rabbitmq-review` until 2026-09-10, when
