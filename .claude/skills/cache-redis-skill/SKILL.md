...
| Request | Mode | Read |
| --- | --- | --- |
| Pool injection, TTL, lock/session/transport guidance | Guide | this file |
| "review `<path>`", quality check of an existing file | **Review** | [`references/review-guide.md`](references/review-guide.md) |

> The Review mode was the slash command `/cache-redis-review` until 2026-09-10, when `.claude/commands/`
> was folded into `.claude/skills/`. `$ARGUMENTS` carries the target path.
