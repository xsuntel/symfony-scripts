...
| Request | Mode | Read |
| --- | --- | --- |
| Entity design, repository queries, migrations, PostgreSQL features | Guide | this file |
| "review `<path>`", quality check of an existing file | **Review** | [`references/review-guide.md`](references/review-guide.md) |

> The Review mode was the slash command `/database-postgresql-review` until 2026-09-10, when
