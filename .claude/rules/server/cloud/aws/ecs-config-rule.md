...
> (@see .claude/rules/server/cloud/gcp/cloudrun-config-rule.md). The shared deployment sources
...
@see .claude/rules/server/base/nginx-config-rule.md — container nginx, TLS termination (ALB), port 8080 exposure
