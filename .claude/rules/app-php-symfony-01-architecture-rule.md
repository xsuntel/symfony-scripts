...
| `Providers/Finance`  | Financial-provider integration                               |
...
```
App\Entity\Providers\Finance\App\Securities\{Provider}\Domestic\Stock\API\REST\Enterprise\ChkHoliday
→ app/src/Entity/Providers/Finance/App/Securities/{Provider}/Domestic/Stock/API/REST/Enterprise/ChkHoliday.php
```
...
- **Route**: `{domain}_{subdomain}_{action}` in snake_case (e.g. `providers_finance_{provider}_list`).
