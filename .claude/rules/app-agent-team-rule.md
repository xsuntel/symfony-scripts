...
@see .claude/rules/utility-agent-team-rule.md — the sibling orchestrator (diagrams · commits · shell · `.claude`) verdict SoT
@see .claude/agents/utility-agent-team.md — that orchestrator's execution directives
...
- **`[MUST]`** — direct-spawning outside the roster; the four teams spawning one another (Mode D
