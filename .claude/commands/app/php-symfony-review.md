...
@see .claude/rules/app/php-symfony/00-overview-rule.md ~ 11-performance-rule.md — judgment criteria (SoT)
@see .claude/output-styles/app/php-symfony-style.md — code style (PSR-12, headers, formatting)
@see .claude/rules/database/postgresql-rule.md — Doctrine-related
@see .claude/rules/api/rest-rule.md — external API-related
